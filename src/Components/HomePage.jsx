...
const HomePage = () => {
  return (
    <div className='main'>
        ...
        <div className='h-4/5'>
        {/* linked button */}
        <div className=' flex flex-col lg:pt-2 sm:pt-1 sm:mr-4'>
        ...
        {/*box */}
        <div className='flex w-full h-fit justify-center pt-8'>
        <div className='flex flex-col'>
            ...
            <div className=' grid grid-flow-row static text-left lg:pl-80 sm:pl-56'>
                <text className='input-text lg:w-[380px] sm:w-[280px] mb-7'>Flower Dataset</text>
                ...
                <div className=' flex flex-col'>
                    ...
                    <text className=' lg:w-[182px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 rounded-[3px]'>10.100.100.84</text>
                </div>
                <div className=' flex flex-col'>
                    <h4 className=' font-mono text-sm font-bold text-[#868686]'>Port</h4>
                    <text className='lg:w-[182px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 rounded-[3px]'>1107</text>
                </div>
                </div>
                ...
                <div className=' flex flex-col'>
                    ...
                    <text className='lg:w-[182px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 mb-8 rounded-[3px]'>Anna</text>
                </div>
                <div className=' flex flex-col'>
                    <h4 className=' font-mono text-sm font-bold text-[#868686]'>Password</h4>
                    <text className='lg:w-[182px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 mb-8 rounded-[3px]'>**********
        ...
        {/* footer button */}
        <div className=' absolute inset-x-0 bottom-0 py-4 flex flex-col justify-center'>
