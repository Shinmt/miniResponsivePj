...
const HomePage = () => {
  return (
    <div className='main'>
        ...
        {/*box */}
        <div className='flex w-full h-fit lg:mt-4 sm:mt-3 justify-center'>
        <div className='flex flex-col '>
            ...
            <div className=' grid grid-flow-row absolute lg:ml-32 sm:ml-10 text-left'>
                ...
                <label className='label-text pt-3'>Location*</label>
                <label className='label-text pt-6'>Authentication*</label>
                <label className='label-text pt-3'>Database Name*</label>
            </div>
            
            {/* right items */}
            <div className=' grid grid-flow-row static text-left lg:pl-80 sm:pl-56'>
                <text className='input-text lg:w-[380px] sm:w-[280px]'>Flower Dataset</text>
                <text className='w-[26px] text-sm font-normal mb-8'>SQL</text>
                <text className='w-[26px] text-sm font-normal mb-8'>MySQL</text>
                <div className=' grid grid-flow-col h-[65px]'>
                    <text className='input-text lg:w-[380px] lg:h-[35px] sm:w-[280px] sm:h-auto'>Tenant
                ...
                <div className=' flex flex-col'>
                    ...
                    <text className=' lg:w-[190px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 mb-8 rounded-[3px]'>10.100.100.84</text>
                </div>
                <div className=' flex flex-col'>
                    <h4 className=' font-mono text-sm font-bold text-[#868686]'>Port</h4>
                    <text className='lg:w-[190px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 mb-8 rounded-[3px]'>1107</text>
                </div>
                </div>
                <div className=' lg:w-[380px] sm:w-[280px] grid grid-cols-2 lg:gap-[14px] sm:gap-5'>
                <div className=' flex flex-col'>
                    <h4 className=' font-mono text-sm font-bold text-[#868686]'>User Name</h4>
                    <text className='lg:w-[190px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 mb-[50px] rounded-[3px]'>Anna</text>
                </div>
                <div className=' flex flex-col'>
                    <h4 className=' font-mono text-sm font-bold text-[#868686]'>Password</h4>
                    <text className='lg:w-[190px] sm:w-[130px] px-4 font-normal text-sm bg-[#EAF0F6] pt-[7px] pb-1.5 mb-[50px] rounded-[3px]'>**********
